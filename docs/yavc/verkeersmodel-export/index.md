...
1. Configuratie per kruispunt
2. Configuratie van de export
...
- Sla de configuratie op, _zonder herberekenen van analyse data._ Dit laatste is belangrijk, omdat anders de analyse data wordt verwijderd en moet worden herberekend, wat hier echter niet nodig is.
