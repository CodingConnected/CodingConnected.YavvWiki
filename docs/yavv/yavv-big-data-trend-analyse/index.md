...
- Filteren data (2): al dan niet gebruik maken van [filtering van data](../../analyse/filtering-functionele-omschrijving/index.md) tijdens uitvoeren van de analyses
