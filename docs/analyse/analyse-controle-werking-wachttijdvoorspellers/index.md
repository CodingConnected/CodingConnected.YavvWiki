...
Bij deze analyse is het meest nuttige overzicht bij de visualisatie van analyse data de "lijst met alle metingen". Door gebruik te maken van [de multivenster omgeving van YAVV](../../yavv/werkbladen-en-gebruikersinterface-van-yavv/index.md) en het analyse tabblad naast/boven/onder de fasenlog te plaatsen, en vervolgens dubbel te klikken op items in de lijst (of enter toets), kan snel worden gekeken wat er aan de hand is.
