...
- De [filtering van YAVV/YAVC zelf](https://www.codingconnected.eu/yavvwiki/filtering/filtering-functionele-omschrijving/) (volgorde filters, korte bezetting, etc.) wordt hierin **nog niet** meegenomen.
